...
- Added Kenneth Marino and Ming-Hsuan Yang as visible panelist speaker cards with local headshots and homepage/Google Scholar links. Sujith Ravi's visible affiliation is **GVP, Oracle AI** and his stale personal homepage link is intentionally removed; Vijay displays **Founder and CTO, Turing**; Kenneth displays **University of Utah / Ex-DeepMind**; Ming-Hsuan displays **UC Merced / DeepMind**. The placeholder panel card **More to be announced / Leaders from Industry & Academia** is hidden.
