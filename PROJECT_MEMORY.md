...
- Added Kenneth Marino and Ming-Hsuan Yang as visible panelist speaker cards with local headshots and homepage/Google Scholar links. Sujith Ravi's visible affiliation is **VP, Oracle AI**; Kenneth displays **University of Utah / Ex-DeepMind**; Ming-Hsuan displays **UC Merced / DeepMind**.
